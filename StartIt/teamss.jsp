  ...
  %>
    ...
    <main class="main">
      ...
      <div class="title-button">
        ...
        <button id="filters-button" onclick="showDiv()">Filters</button>
      </div>
          ...
          <div class="content">
            ...
            <div class="middle">
              ...
              <div style="border-radius: 8px; height: 5px; background-color: #60E1CC47;">
                <div style= "border-radius: 8px; height: 5px; width: 70%; background-color: #24a148;">&nbsp;</div>
              </div>
            </div>
            <div class="bottom" >
              <button onclick="window.location.href='team-profile.html'" class="team-button">Team Profile</button>
            </div>
          </div>
        </div>
        <%}%>
